...
export const hexagonBullet = (enemy) => { 
  ...
  hexBullet.update = () => {
    ...
    hexBullet.velocityX += hexBullet.accelX;
...
export const hexagonBullet2 = (enemy) => { 
  ...
  // hexBullet.accelX = hexBullet.velocityX >= 0 ? 0.05 : -0.05;
  // hexBullet.accelY = hexBullet.velocityY >= 0 ? 0.05 : -0.05;
